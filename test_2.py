...
def prueba_linea(linea):
    ...
    if linea[0:4] != "null":
        ...
        linea5 = re.findall(r"[A-Z]*[a-z]*[\w]+", linea)
...
#def valida_linea(linea):

#	res1 = re.findall(r"([A-Z]+[a-z]+\s[a-z]+\s[a-z]+\:)",linea)
#    res2 = re.findall(r"fgjdfk;lgjkld;fjgklsdfgfasdfasfsf", linea)

	#If match is found, the string is valid
#	if res1:
		#print(f"Linea {linea} detectada")
#		print(res1)
